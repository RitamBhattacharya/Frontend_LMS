...
//   const handleApprove = () => {
//     axios
//       .put(`http://localhost:8080/api/leave-requests/${requestId}/approve`, { remarks })
//       .then(() => {
//         setLeave((prev) => ({ ...prev, status: "Approved" }));
//         navigate(`/approved-leave-details/${requestId}`);
//       })
//       .catch((err) => console.error("Approval failed", err));
//   };
...
//   const handleReject = () => {
//     axios
//       .put(`http://localhost:8080/api/leave-requests/${requestId}/reject`, { remarks })
//       .then(() => {
//         setLeave((prev) => ({ ...prev, status: "Rejected" }));
//         navigate("/admin/leave/rejected");
//       })
